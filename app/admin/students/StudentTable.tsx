...
import { removeCourseFromStudent } from "@/app/actions/admin";
...
const StudentEditModal = dynamic(() => import("@/components/admin/students/StudentEditModal"), { 
  ssr: false,
...
const AssignCourseModal = dynamic(() => import("@/components/admin/students/AssignCourseModal"), { 
  ssr: false 
});

const BatchAssignmentModal = dynamic(() => import("@/components/admin/students/BatchAssignmentModal"), { 
  ssr: false 
});
