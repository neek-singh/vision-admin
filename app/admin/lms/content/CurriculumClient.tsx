...
const ChapterFormModal = dynamic(() => import("@/components/admin/lms/ChapterFormModal"), { ssr: false });
const LessonFormModal = dynamic(() => import("@/components/admin/lms/LessonFormModal"), { ssr: false });
const LessonPreviewModal = dynamic(() => import("@/components/admin/lms/LessonPreviewModal"), { ssr: false });
