...
export default function LessonFormModal({ 
  ...
  const isTypePreSelected = !!(initialData?.type || initialData?.lesson_type);
  ...
  const addBlock = (type: 'header' | 'paragraph' | 'image' | 'list') => {
                        ...
                        <div className="flex-1 space-y-2">
                          ...
                          {block.type === 'paragraph' && (
                            <textarea 
                              ...
                              onChange={(e) => updateBlockValue(index, e.target.value)}
                              className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm font-medium text-slate-700 min-h-[80px] outline-none focus:border-blue-500 transition-colors"
                            />
                          )}
                          ...
                          <>
                            <div className="space-y-2">
                              ...
                              <textarea 
                                ...
                                className="w-full px-3 py-2 bg-slate-50 border border-slate-200 rounded-xl text-sm font-semibold text-slate-900 outline-none focus:border-blue-500 transition-colors min-h-[60px]"
                              />
                            </div>
