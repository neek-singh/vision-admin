...
import { saveCourse } from "@/app/actions/lms/courses";
...
export default function CourseForm({ course }: { course?: Course }) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-8 max-w-5xl bg-white p-2 rounded-[2.5rem] border border-gray-100 shadow-xl overflow-hidden font-black text-black">
